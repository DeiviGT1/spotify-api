...
def-env activate-virtualenv [] {
    ...
    let virtual_env = '/Users/david/Documents/API-spotify/web-api-examples/authentication 2/authorization_code/venv'
    let bin = 'bin'
    let path_sep = ':'
...
alias deactivate = source '/Users/david/Documents/API-spotify/web-api-examples/authentication 2/authorization_code/venv/bin/deactivate.nu'
